...
public class HeaderAdapterScore extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HeaderAdapterScore(List<Score> data, Member member) {
        this.mValues = data;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewHolderScore) {
            ...
            viewHolderScore.mItem = score;
            viewHolderScore.mScoreText.setText(score.getName());
            viewHolderScore.mScoreTotal.setText(viewHolderScore.mScoreValue.toString());
        }
    }
